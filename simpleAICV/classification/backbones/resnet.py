...
model_urls = {
    'resnet18_sample':
    '{}/resnet/resnet18-epoch90-acc71.616.pth'.format(pretrained_models_path),
    'resnet34_half_sample':
    ...
    'resnet50_half_sample':
    '{}/resnet/resnet50_half-epoch100-acc72.066.pth'.format(
        pretrained_models_path),
    'resnet50_sample':
    '{}/resnet/resnet50-epoch90-acc77.432.pth'.format(pretrained_models_path),
    'resnet101_sample':
    ...
    '{}/resnet/resnet152-epoch100-acc78.564.pth'.format(
        pretrained_models_path),
    'resnext50_32x4d_sample':
    'empty',
    'resnext101_32x8d_sample':
    'empty',
    'wide_resnet50_2_sample':
    'empty',
    'wide_resnet101_2_sample':
    'empty',
}
...
class ChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=16):
        ...
        self.fc11   = nn.Conv2d(in_planes, in_planes // 16, 1, bias=False)
        self.fc22   = nn.Conv2d(in_planes // 16, in_planes, 1, bias=False)
    ...
    def forward(self, x):
        ...
        max_out = self.fc22(self.relu1(self.fc11(self.max_pool(x))))
        out = avg_out + max_out
...
class BasicBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.stride = stride
        self.planes = planes
        self.conv0 = conv1x1(inplanes, planes )
        self.conv1 = conv3x3(inplanes, planes, stride = 1)
        
        self.cbamfc = SpatialAttention_conv()
        
        self.bn1 = norm_layer(planes)
        self.relu = nn.ReLU(inplace=True)
        
        self.conv2 = conv3x3(planes, planes)
        self.conv2att = conv3x3(planes, 1)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv21 = conv3x3(width, width, groups, dilation)
        ...
        self.downsample = downsample
        self.stride = stride
        self.se = ChannelAttention(width)
        
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
        self.conv2att = conv3x3(width, 1)
...
class ResNet(nn.Module):
    def __init__(self,
        ...
        self.avgpool = globalmaxBiasAvgPool()
...
def resnet18_sample(pretrained=False, **kwargs):
    kwargs['inplanes'] = 64 
